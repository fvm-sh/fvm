# Flutter Version Manager [![fvm version](https://img.shields.io/badge/version-v0.2.3-40d0fd.svg)][2]
...
```sh
curl -o- https://raw.githubusercontent.com/fvm-sh/fvm/v0.2.3/install.sh | bash
```
```sh
wget -qO- https://raw.githubusercontent.com/fvm-sh/fvm/v0.2.3/install.sh | bash
```
...
1. `cd ~/.fvm` and check out the latest version with `git checkout v0.2.3`
...
[1]: https://github.com/fvm-sh/fvm/blob/v0.2.3/install.sh
[2]: https://github.com/fvm-sh/fvm/releases/tag/v0.2.3
