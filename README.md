# Flutter Version Manager [![fvm version](https://img.shields.io/badge/version-v0.5.1-40d0fd.svg)][2]
...
1. `cd ~/.fvm` and check out the latest version with `git checkout v0.5.1`
...
[1]: https://github.com/fvm-sh/fvm/blob/v0.5.1/install.sh
[2]: https://github.com/fvm-sh/fvm/releases/tag/v0.5.1
